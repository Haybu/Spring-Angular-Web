...
var FlightsService = /** @class */ (function () {
    ...
    FlightsService.prototype.searchFlights = function (from, to, date) {
        ...
        var url = "http://localhost:8088/api/reservations/search/" + from + "/" + to + "/" + dt;
    ...
    FlightsService.prototype.searchAllFlights = function (from, to, outdate, indate) {
        ...
        //let url = "/api/reservations/search/"+from+"/"+to+"/"+dt;
        var url1 = "http://localhost:8088/api/reservations/search/" + from + "/" + to + "/" + outDt;
        var url2 = "http://localhost:8088/api/reservations/search/" + to + "/" + from + "/" + inDt;
    ...
    FlightsService.prototype.book = function (flightId, passenger, address) {
        ...
        var url = "http://localhost:8088/api/reservations/book";
...
module.exports = __webpack_require__(/*! /Users/hmohamed/github/agilehandy.io/Spring-Angular-Web/agency-ui/src/main.ts */"./src/main.ts");
